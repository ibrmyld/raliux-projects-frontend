...
const CommentSection = ({ postId }) => {
  ...
  const fetchComments = async () => {
    try {
      setLoading(true);
      const response = await fetch(createApiUrl(`/api/comments/${postId}`));
  ...
  const handleSubmitComment = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Refresh comments listesini güncelle
        fetchComments();
      } else {
        let errorMessage = 'Failed to add comment';
        try {
          const errorData = await response.json();
          console.error('❌ Comment submit error:', errorData);
  ...
  // Edit/Delete functions removed - not implemented in backend yet
                ...
                <div className="flex space-x-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {/* Actions - Edit/Delete removed for now */}
                    </div>
