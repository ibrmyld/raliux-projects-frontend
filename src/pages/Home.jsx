...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Ana Sayfa"
        description="Raliux - Modern teknoloji platformu. Web geliştirme, yapay zeka, siber güvenlik ve teknoloji hakkında güncel içerikler."
        keywords={['blog', 'teknoloji', 'web geliştirme', 'yapay zeka', 'AI', 'siber güvenlik', 'programlama', 'React', 'JavaScript']}
        type="website"
        url="/"
      />
