  ...
  return (
    <div className="min-h-screen py-8">
      <SEOHead
        ...
        description="Geliştiriciler ve güvenlik uzmanları için ücretsiz araçlar ve yardımcı programlar. Dosya tarayıcı, kod analizi ve daha fazlası."
        keywords={['ücretsiz araçlar', 'geliştirici araçları', 'güvenlik araçları', 'kod analizi', 'dosya tarayıcı', 'web araçları']}
        type="website"
        url="/tools"
      />
